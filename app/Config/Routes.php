...
$routes->get('/users', 'UserController::delete');
...
$routes->add('/detail/edit/(:segment)', 'DetailController::edit/$1');
$routes->get('/detail/delete/(:segment)', 'DetailController::delete/$1');
